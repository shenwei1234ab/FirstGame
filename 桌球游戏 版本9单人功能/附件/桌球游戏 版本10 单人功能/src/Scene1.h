...
{
public:
	Scene1():m_Score(0),m_MainBall(0),m_ballArm(0)
	{
...
#pragma region  添加UI
		...
		if (btn)
		{
			...
			btn->SetMouseMoveInEvent((UIButton::PFN_MOUSEMOVEIN)&Scene1::MouseMoveIn);
			btn->SetMouseMoveOutEvent((UIButton::PFN_MOUSEMOVEIN)&Scene1::MouseMoveOut);
		}
...
#pragma region  添加物理
		...
		//添加球杆
		m_ballArm = new BallArm(200,m_MainBall.get(),200,20,5.f,100.f);
		return true;
#pragma endregion
	}
#pragma endregion 
